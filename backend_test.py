...
class ChyllAppAPITester:
    ...
    def run_all_tests(self):
        ...
        # User Profile & Favorites endpoint tests (Sprint 2.1)
        print("\n" + "=" * 60)
        print("👤 Testing User Profiles & Favorites (Sprint 2.1)")
        print("=" * 60)
        self.test_user_profile_without_auth()
        self.test_user_profile_with_invalid_token()
        self.test_update_profile_without_auth()
        self.test_update_profile_with_invalid_token()
        self.test_toggle_favorite_without_auth()
        self.test_toggle_favorite_with_invalid_token()
        self.test_get_favorites_without_auth()
        self.test_get_favorites_with_invalid_token()
        self.test_update_preferences_without_auth()
        self.test_update_preferences_with_invalid_token()
        self.test_get_activity_without_auth()
